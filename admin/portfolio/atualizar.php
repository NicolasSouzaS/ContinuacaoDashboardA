...
if(isset($_POST['statusPortfolio'])){
    ...
    $statusPortfolio = $_POST['statusPortfolio'];
     ...
     if(!empty($_FILES['inputImg']['name'])){
        ...
        $imgPortfolio = $portfolio->imgPortfolio;
     }
...
<section style="display: flex;justify-content: space-between; align-items: center;">
    ...
    <h1 class="container d-flex justify-content-center align-items-center" style="margin-bottom:80px;">Atualização do Projeto:<?php echo $id; ?></h1>
...
<div class="container-fluid page-height d-flex justify-content-center align-items-center">
    <form action="index.php?p=projetoAtualizar&id=<?php echo $portfolio->idPortfolio?>" method="POST" enctype="multipart/form-data" class="">
        <div class="input__containerPortfolio">
        <img name="imgEscolhida" style="width: 600px; height:400px; border-radius:20px;" id="imgEscolhida" src="<?php echo '../img/projetos/'. $portfolio->imgPortfolio ?>" alt="Imagem Escolhida">
        ...
        <input placeholder="Titulo" id="inputTitulo" class="input" name="inputTitulo" type="text">
                ...
                <label style="margin-left:1%; margin-top:1%; font-size:14pt" class="containerBtn" value="1" name="statusPortfolio">
                    <input checked="checked" value="1" name="statusPortfolio" type="checkbox">
            ...
            <div style="margin-left:32%; margin-top: 0%;">
