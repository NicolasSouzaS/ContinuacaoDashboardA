...
if(isset($_POST['tituloServico'])){
    ...
    $tituloBlocoServico = $_POST['inputServico'];
...
<div class="container-fluid page-height d-flex justify-content-center align-items-center">
    <form action="index.php?p=insertServico" method="POST" ectype="multipart/form-data" class="container-md">
        <div class="input__container">
            <label class="input__label">Titulo do serviço</label>
            <input placeholder="Titulo" id="inputTitulo" class="input" name="TituloServico" type="text">

            <label class="input__label">Icon Serviço </label>
            <input placeholder="Insira o icon com classe e tag. Exemplo: <i class='fa-solid fa-image'></i>" id="inputIcon" class="input" name="iconServico" type="text">

            <label class="input__label">Texto bloco serviço</label>
            <textarea style="padding-left:5px; border-radius:20px;" placeholder="Texto" style="border-radius:20px;" name="TextoBlocoServico" id="txtArea" cols="20" rows="5"></textarea>
