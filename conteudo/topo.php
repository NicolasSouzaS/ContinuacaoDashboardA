...
?>
        ...
        <ul>
            ...
            <span class="linha"></span>
            <li><a href="projetos.php" <?php if($urlBase == 'servico.php') echo 'class="ativo"'; ?>>Portfólio</a></li>
            <span class="linha"></span>
            <li><a href="avaliacoes.php" <?php if($urlBase == 'contato.php') echo 'class="ativo"'; ?>>Avaliações</a></li>
            <span class="linha"></span>
            <li><a href="index.php#blog" <?php if($urlBase == 'contato.php') echo 'class="ativo"'; ?>>Blog</a></li>
        </ul>
    </div>
